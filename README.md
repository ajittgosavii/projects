...
Use a Python that has Playwright installed. A plain `streamlit run` may pick a different interpreter: the page then still lists apps, but says the browser actions are disabled.
